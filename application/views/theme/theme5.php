...
<html>
  ...
  <head>
    ...
    <link rel="stylesheet" href="<?= base_url() ?>w3style5.css">
  ...
  <body>
    ...
    <div id="Cover" class="tabcontent">
      ...
      <div class="corner1">
        <img src="<?= base_url() ?>/assets/de13oraset1.png" alt="" width="100%">
      </div>
      <div class="corner2">
        <img src="<?= base_url() ?>/assets/de13oraset2.png" alt="" width="100%">
      </div>
      <div class="corner3">
        <img src="<?= base_url() ?>/assets/de13oraset3.png" alt="" width="100%">
      </div>
      <div class="corner4">
        <img src="<?= base_url() ?>/assets/de13oraset4.png" alt="" width="100%">
      </div>
      <div class="corner5">
        <img src="<?= base_url() ?>/assets/de13oraset5.png" alt="" width="100%">
      </div>
      <div class="corner6">
        <img src="<?= base_url() ?>/assets/de13oraset6.png" alt="" width="100%">
      </div>
      <div id="homewd" class="contentwd">
        ...
        <div class="content4pad">
          ...
          <div class="borderpair">
            ...
            <div class="behindcname w3-spin"><img src="<?= base_url() ?>/assets/de13namecirclepair.png"></div>
          </div>
          ...
          <div class="ornamentbg" style="width: 100%; margin: 0px; text-align: center;">
            <img src="<?= base_url() ?>/assets/de13swirlwd.png" alt="" style="display: inline-block; opacity: 0.3">
          </div>
        </div>
  ...
  <!-- Mirrored from.com/demo/design13/ by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 07 Dec 2021 03:48:33 GMT -->
</html>