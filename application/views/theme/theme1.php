...
<html>
  ...
  <head>
    ...
    <meta property="og:image" content="<?= base_url() ?>/assets/ogthumbnail.jpg" />
    <meta property="og:title" content="JendSas Wedding Invitation" />
    <meta property="og:description" content="Official. You are invited to. Jendrowati & Sastrowo" />
    <link rel="stylesheet" href="<?= base_url() ?>w3style1.css">
    ...
    <style>
      * {
      ...
      @font-face {
      src: url('<?= base_url() ?>/atemplate/aldhyaksa.html');
      font-family: yaksa;
      }
      .iconbar {
      position: fixed;
      ...
      background-image: url("<?= base_url() ?>/assets/rustic.html") overflow: auto;
      z-index: 999999;
      }
      .iconbar a {
      float: left;
      ...
      .boardcust {
      background-image: url("<?= base_url() ?>/assets/bgpaper.jpg");
      opacity: 0.9;
      border-radius: 10px;
      border-style: solid;
      border-color: #c0923c;
  ...
  <body>
    <div class="music-box">
      ...
      <img border="0" alt="" src="<?= base_url() ?>/assets/soundmusicwd.png"
        width="20" height="20">
      </button>
      <button type="button" class="music" id="unmute-sound">
      <img border="0" alt="" src="<?= base_url() ?>/assets/soundmusicoffwd.png"
        width="20" height="20">
      </button>
      </button>
    </div>
    <div class="iconbar">
      <a class="tablink" onclick="openPage('Cover', this, '#292929')" id="defaultOpen"><img src="<?= base_url() ?>/assets/tab1cover.png" width="35"></a>
      <a class="tablink" onclick="openPage('Couple', this, '#292929')"><img src="<?= base_url() ?>/assets/tab2couple.png" width="35"></a>
      <a class="tablink" onclick="openPage('Eventwd', this, '#292929')"><img src="<?= base_url() ?>/assets/tab3event.png" width="35"></a>
      <a class="tablink" onclick="openPage('Moment', this, '#292929')"><img src="<?= base_url() ?>/assets/tab4moment.png" width="35"></a>
    </div>
    <div id="Cover" class="tabcontent">
      <!-- <h3>Home</h3>
        <p>Home is where the heart is..</p> -->
      <div class="corner1">
        <img src="<?= base_url() ?>/assets/oraset1.png" alt="" width="100%">
      </div>
      <div class="corner2">
        <img src="<?= base_url() ?>/assets/oraset2.png" alt="" width="100%">
      </div>
      <div class="corner3">
        <img src="<?= base_url() ?>/assets/oraset3.png" alt="" width="100%">
      </div>
      <div class="corner4">
        <img src="<?= base_url() ?>/assets/oraset4.png" alt="" width="100%">
      </div>
      <div id="homewd" class="contentwd">
        <div class="ornamentwdtop" style="width: 100%; margin: 0px; text-align: center;">
          <img src="<?= base_url() ?>/assets/vintopwd.png" alt="" style="display: inline-block;" width="100%">
        </div>
        <div>
          <h2 style="color: #c0923c; font-size: 35px; font-family: Angelface; padding-top: 10px">- The Wedding -<br><span style="font-size:12px" class="explainbride">Official Invitation</span></h2>
        </div>
        <div><img src="<?= base_url() ?>/assets/wayang.png" width="30%" alt=""></div>
        <div class="fontfront">Jendro <span style="font-size:35px">&</span> Sastro</div>
        <p style="color: #c0923c; font-weight:bold; padding-top:10px; padding-bottom:10px; border-radius:4px" id="write"></p>
        <div>
          <a href="https://calendar.google.com/event?action=aTEMPLATE&amp;tmeid=NzVkYWxyOWVqaGl1czdlYmxnZnQ3NmwybzggYmxrb2M5ZHFvcGs3a2trNm9nNnAzNDlzaDRAZw&amp;tmsrc=blkoc9dqopk7kkk6og6p349sh4%40group.calendar.google.com" target="_blank" style="background-color: #c0923c; font-family: dosis; font-size: 18px; color: white; padding: 18px 30px; text-align: center; text-decoration: none; display: inline-block; border-radius: 8px"><strong>SaveTheDate</strong></a>
          <p style="color: #c0923c; font-size: 30px; font-family: Angelface; padding-top: 1px">| 28 . Maret . 2020 | <br><span style="font-size:12px" class="explainbride">Magelang</span></p>
          <br>
        </div>
        <div class="ornamentbg" style="width: 100%; margin: 0px; text-align: center;">
          <img src="<?= base_url() ?>/assets/swirlwd.png" alt="" style="display: inline-block;">
        </div>
        <br>
        <div class="ornamentwdbtm" style="width: 100%; margin: 0px; text-align: center;">
          <img src="<?= base_url() ?>/assets/vinbtmwd.png" alt="" style="display: inline-block;">
        </div>
        <br>
        <br>
        <br>
    ...
    <div id="Couple" class="tabcontent">
      ...
      <div id="bridewd" class="contentwd">
        <div class="ornamentwdtop" style="width: 100%; margin: 0px; text-align: center;">
          <img src="<?= base_url() ?>/assets/vintopwd.png" alt="" style="display: inline-block;">
        </div>
        <div class="boardcust">
          <h3 style="font-family: Angelface; font-size: 35px">Bismillahirrahmanirrahim</h3>
          <div>
            <br>
            <div class="explainbride">Assalamu`alaikum Warahmatullahi Wabarakatuh<br><br> Maha Suci Allah<br>yang telah menciptakan makhluk-Nya<br>berpasang-pasangan.<br>Ya Allah semoga ridho-Mu tercurah<br>mengiringi pernikahan putra-putri kami:</div>
          </div>
          <br>
          <div><img src="<?= base_url() ?>/assets/wdbride.png" width="40%" alt=""><br><span class="bridefont">Jendrowati</span>
          </div>
          <div class="explainbride">Putri dari<br>Bpk. Adiminto R. & Ibu Sulaiyu Asih</div>
          <br>
          <div class="explainbride">dan</div>
          <br>
          <div><img src="<?= base_url() ?>/assets/wdgroom.png" width="40%" alt=""><br><span class="bridefont">Sastrowo</span>
          </div>
        ...
        <div class="ornamentwdbtm" style="width: 100%; margin: 0px; text-align: center;">
          <img src="<?= base_url() ?>/assets/vinbtmwd.png" alt="" style="display: inline-block;" width="100%">
        </div>
        <br>
        <br>
        <br>
    ...
    <div id="Eventwd" class="tabcontent">
      ...
      <div id="homewd" class="contentwd">
        ...
        <div class="boardcust">
          <h3 style="font-family: Angelface; font-size: 35px">Event</h3>
          <p class="explainbride">The Happy Day!</p>
          <br>
          <p class="explainbride" style="padding-left: 5px; padding-right: 5px">Dengan memohon rahmat dan ridho Allah Subhanahu Wa Ta'ala, kami mengundang Bapak/Ibu/Saudara(i) untuk menghadiri Resepsi Pernikahan putra-putri kami</p>
          <div class="containerijabwd">
            <div>
              <p style="font-size: 18px; font-family: dosis; padding-top: 50px"><b>Akad Pernikahan</b></p>
            </div>
            <table>
              <tr>
                <td><img src="<?= base_url() ?>/assets/tab1cover.png" width="15"></td>
          ...
          <div class="containerweddingwd">
            <div>
              <p style="font-size: 18px; font-family: dosis; padding-top: 10px"><b>Resepsi Pernikahan</b></p>
            </div>
            <table align="right">
              <tr align="right">
                <td>Sabtu, 28 Maret 2020</td>
          ...
          <br>
          <div><a href="https://goo.gl/maps/1bjdKs93RDBXkmKx6" target="_blank" style="background-color: #c0923c; font-family: dosis; font-size: 18px; color: white; padding: 18px 30px; text-align: center; text-decoration: none; display: inline-block; border-radius: 8px"><strong>OpenMap</strong></a>
          </div>
          <br>
        </div>
        <div class="ornamentwdbtm" style="width: 100%; margin: 0px; text-align: center;">
    ...
    <div id="Moment" class="tabcontent">
      ...
      <div id="homewd" class="contentwd">
        ...
        <div class="boardcust">
          <h3 style="font-family: Angelface; font-size: 35px">Gallery</h3>
          ...
          <div class="w3-main w3-content" style="max-width:1600px;margin-top:20px">
            ...
            <div class="w3-row w3-grayscale-min">
              <div class="w3-half">
                <img src="<?= base_url() ?>/assets/gal01.jpg" style="width:100%" onclick="onClick(this)" alt="JendroSastro">
                <img src="<?= base_url() ?>/assets/gal03.jpg" style="width:100%" onclick="onClick(this)" alt="JendroSastro">
                <img src="<?= base_url() ?>/assets/gal05.jpg" style="width:100%" onclick="onClick(this)" alt="JendroSastro">
                <img src="<?= base_url() ?>/assets/gal07.jpg" style="width:100%" onclick="onClick(this)" alt="JendroSastro">
                <img src="<?= base_url() ?>/assets/gal09.jpg" style="width:100%" onclick="onClick(this)" alt="JendroSastro">
              </div>
              <div class="w3-half">
                <img src="<?= base_url() ?>/assets/gal02.jpg" style="width:100%" onclick="onClick(this)" alt="JendroSastro">
                <img src="<?= base_url() ?>/assets/gal04.jpg" style="width:100%" onclick="onClick(this)" alt="JendroSastro">
                <img src="<?= base_url() ?>/assets/gal06.jpg" style="width:100%" onclick="onClick(this)" alt="JendroSastro">
                <img src="<?= base_url() ?>/assets/gal08.jpg" style="width:100%" onclick="onClick(this)" alt="JendroSastro">
                <img src="<?= base_url() ?>/assets/gal10.jpg" style="width:100%" onclick="onClick(this)" alt="JendroSastro">
              </div>
            </div>
    ...
    <script>
      ...
      var deadline = new Date("<?= date('F d, Y H:i:s', mktime(0, 0, 13, date('m'), date('d') + 5, date('Y'))) ?>").getTime();
